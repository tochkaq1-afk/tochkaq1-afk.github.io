...
const DEFAULTS = {
  ...
  /* «Скорость», а не «Lighthouse»: название инструмента знают разработчики,
     а заказчику нужно понимать надпись без объяснений. Шкала 0–100 — та же,
     это балл из отчёта Lighthouse, просто названный по-человечески */
  txtMacTagL:'Скорость',
  txtMacTagBL:'SEO',
